...
public class NoticeDAO {
	...
	/*public int deleteBoard(int no) {
		//삭제질의
		String sql = NoticeSql.getSQL(NoticeSql.DELETE_BOARD);
	...
	public void updateBoard(String title, String body, int no) {
		//수정질의
		String sql = NoticeSql.getSQL(NoticeSql.UPDATE_BOARD);
		PreparedStatement stmt = db.getSTMT(con, sql);
	...
	//원글	상세보기
	public NoticeVO selectDetail(int no) {
		String sql = NoticeSql.getSQL(NoticeSql.SELECT_DETAIL);
		PreparedStatement stmt = db.getSTMT(con, sql);
		//결과물을 담기위한 변수
