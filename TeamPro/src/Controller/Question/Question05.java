...
public class Question05 implements DgSuperController{
	
	@Override
	public String execute(HttpServletRequest req, HttpServletResponse resp) {
		System.out.println("5번 컨트롤러");
		...
		String sum4 = req.getParameter("sum4");
		...
		QuestionDAO dao = new QuestionDAO();
			...
			int sum5 = dao.getSum(bt1,bt2,bt3,bt4,bt5,bt6,bt7,bt8,bt9,bt10);
		...
		System.out.println("sum5 = "+sum5);
			...
			return "../VIEW/Question/QuesResult.jsp";
