...
public class Question01 implements DgSuperController{
	
	@Override
	public String execute(HttpServletRequest req, HttpServletResponse resp) {
		System.out.println("1번 컨트롤러");
		...
		QuestionDAO dao = new QuestionDAO();
			...
			int sum1 = dao.getSum(bt1,bt2,bt3,bt4,bt5,bt6,bt7,bt8,bt9,bt10);			
			dao.close();
		...
		req.setAttribute("SUM1", sum1);
			...
			return "../VIEW/Question/Question02.jsp";
