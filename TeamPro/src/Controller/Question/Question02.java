...
public class Question02 implements DgSuperController{

	
	@Override
	public String execute(HttpServletRequest req, HttpServletResponse resp) {
		System.out.println("2번 컨트롤러");
		...
		QuestionDAO dao = new QuestionDAO();
			...
			int sum2 = dao.getSum(bt1,bt2,bt3,bt4,bt5,bt6,bt7,bt8,bt9,bt10);
			dao.close();
		...
		req.setAttribute("SUM2", sum2);
			...
			return "../VIEW/Question/Question03.jsp";
