...
<script>
	$(document).ready(function(){	//body를 다 읽고 시작
		...
		$('#lBtn').click(function(){
			...
			$(location).attr("href","../AdNotice/BoardList.br?nowPage=${nowPage}");
		});
		//적절한 이벤트를 이용하여 적절한 요청처리(컨트롤러->뷰)
		//id="mBtn" value="(원글)수정하기"/>
		$('#mBtn').click(function(){
			$(location).attr("href","../AdNotice/ModifyForm.br?no=${VIEW.no}&nowPage=${nowPage}")
		})
		//id="dBtn" value="삭제하기"/>
		$('#dBtn').click(function(){
			//1. 삭제선택,취소(팝업)
...
<div class="jumbotron jumbotron-fluid">
	...
	<form id="imsiFrm" method="POST" action="../AdNotice/BoardDelete.br">
