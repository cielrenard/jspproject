...
//http://localhost:8080/AJAXPro/db/zipSearch.jsp
//String sido="DJ";
//String gugun="Seo-gu";
...
//select distinct zipcode, sigungu,ubmyun,dong1,dong2, ri,roadnm,bldnm
//from dj where  roadcode='301704298372' and sigungueng='Seo-gu'
//order by roadnm;
String sql="";
if(sido.equals("SJ")){
...
while(rs.next()){
	...
	map.put("addr",addr);
	list.add(map);
	//12345 서울 구로구 구로중앙로 34길 (구로5동 영림빌딩)
}
rs.close();
st.close();
con.close();%>
