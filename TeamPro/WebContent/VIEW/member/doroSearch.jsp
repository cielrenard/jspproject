...
//http://localhost:8080/AJAXPro/db/doroSearch.jsp
//String sido="DJ";
//String gugun="Seo-gu";
...
String sql="";
//select distinct ROADCODE,ROADNM from dj where sigungueng='Seo-gu';
if(sido.equals("SJ")){
	sql="select distinct ROADCODE,ROADNM from "+sido+" order by roadnm";
}else{
	sql="select distinct ROADCODE,ROADNM from "+sido+
				" where sigungueng='"+gugun+"' order by roadnm";
}
