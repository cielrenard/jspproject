...
<div class="solar-system">
	<div class="circle01" align="center">
        ...
        <div class="round01">
    		...
    		<div class="tit ta-c">
        		<h1><div><marquee behavior=slide direction=right scrolldelay="50">B</marquee></div>
        		<div><marquee behavior=slide direction=right scrolldelay="100">R</marquee></div>
        		<div><marquee behavior=slide direction=right scrolldelay="150">O</marquee></div>
        		<div><marquee behavior=slide direction=right scrolldelay="200">S</marquee></div></h1>
        		<p><marquee behavior=slide direction=right scrolldelay="250">BROS</marquee></p>
    		</div>
   		</div>
    </div>
</div>
