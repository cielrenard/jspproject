...
<link rel="stylesheet" href="/BROS/VIEW/Product/normalize.css">
<link rel="stylesheet" href="/BROS/VIEW/Product/main.css">
<link rel="stylesheet" href="/BROS/VIEW/Product/headhesive.css">
...
<!-- 	<script>
	...
	<%--베너 이벤트--%>	
	<script type="text/javascript" src="/BROS/VIEW/Product/headhesive.min.js"></script>	
	<script>
		//Set options 
		var options = {
			offset: '#showHere',
...
<body>	
    ...
    <%--내용--%>	
	<div class="box" id="section1" style="background-size: 300; background-image:url(/BROS/VIEW/Product/architecture-1850129_1920.jpg)">
		<%--베너--%>
				...
				<div class="container-fluid">
					<div class="navbar-header">
						<button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
							...
							<a class="navbar-brand" href="#" style="padding: 5px; font-family: Serif; font-weight: bold; font-size: 20px"><img style="max-width: 300px"src="/BROS/VIEW/Product/title-img2.png"/></a>
					</div>
		...
		<script src="../js/bootstrap.js"s></script> 
		<header class="banner" id="banner2" style="align: center; border: 0px">
			<nav class="navbar navbar-default" style="margin: 0px; height: 130px; border: 0px; background-color: rgba(255,255,255,0)">
				<img src="/BROS/VIEW/Product/title-img.png"/></br>
					<div class="container-fluid">
						<div class="navbar-header">
							<button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
								data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
	...
	<%--Section--%>
	<div class="box" id="section2" style="background-image:url(/BROS/VIEW/Product/eunwoo3.jpg)">
...
<!-- 	       	It's choice - not chance - that determines your destiny.</br> -->
	...
	<div class="box" id="section3" style="background-size: 100%; background-image:url(/BROS/VIEW/Product/apple-1873078_1280.jpg)">
        <div id="section3-1" class="container-fluid">
            ...
            <div id="section3-b" class="container-fluid" style="font-size: 18pt">
                <h3 style="text-align: right; font-family: 굴림; font-size: 18px; color: grey">
	...
	<div class="box" id="section4" style="background-size: 100%; background-image:url(/BROS/VIEW/Product/lavender-blossom-1595581_1280.jpg)">
	...
	<div class="box" id="section5" style="background-size: 100%; background-image:url(/BROS/VIEW/Product/dna-3539309_1280.jpg)">
		...
		<c:forEach var="temp" items="${LIST}">
			<ul style="list-style:none; float:left">
				...
				<li style="color: black; text-align: center">
					...
					<img id="item2" style="width: 253px; height: 253px;" src="../img/${temp.cfile}"/>
					</a>
				</li>
	...
	<table style="margin: auto; height: 80px; width: 1430px; background-color: #ffffff">
		<tr>
			<td align="center">
			<%--[이전]링크만들기--%>
	...
	<table style="margin: auto; height: 80px; width: 1430px; background-color: #ffffff">
		<tr>
			<td align="center">
				<input type="button" id="wbtn" value="UPDATE" onClick="UpdateForm();"/>
			</td>
		</tr>
	</table>
	</div>
	<div class="box" id="section6" style=" padding: 80px; background-color:#f2f2f2;">
	<table style="margin: auto; height: 800px; width: 1430px; background-size: 100%; background-image:url(/BROS/VIEW/Product/eunwoo2.jpg)">
		<tr>
